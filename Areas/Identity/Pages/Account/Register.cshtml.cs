...
namespace TheKitchen.Areas.Identity.Pages.Account
{
    public class RegisterModel : PageModel
    {
        ...
        private RBUser CreateUser()
        {
            ...
            {
                throw new InvalidOperationException($"Can't create an instance of '{nameof(RBUser)}'. " +
                    $"Ensure that '{nameof(RBUser)}' is not an abstract class and has a parameterless constructor, or alternatively " +
